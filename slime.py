...
score1 =0
score2 =0
dessusgoallargeur = 130
dessusgoalhauteur = 20
...
jou1vit = [ 0.0 , 0.0]
jou2vit = [ 0.0 , 0.0]
dessusgoal1pos = [ 0 , 455]
dessusgoal2pos = [ 1150 , 455]
...
def menu_intro():
    ...
    while menu :
          ...
          if 580>= m[0]>=550 and 390 >= m[1] >= 350 or 610 >= m[0] >= 580 and 405 >= m[1]>315 or 670 >= m[0] >= 610 and 420 >= m[1] >=300 or 700 >= m[0] >= 670 and 400 >= m[1] >= 315  :
                   ...
                   fenetre.blit(goal1 , (-30, 455))
                   fenetre.blit(goal2 , (fenetre_l-130,455))
          ...
          titrejeu = pygame.image.load('files/titre.png').convert_alpha(fenetre)
...
##################################
### DEB COLLISION DESSUS GOALS ###
################################## 
def test_collision(rect):
    ball_rect = pygame.Rect((ballepos[H]-balle_rayon, ballepos[V]-balle_rayon), (balle_rayon*2, balle_rayon*2))
...
paused =time.time()
joueur1 = pygame.image.load('files/joueur1.png').convert_alpha(fenetre)
joueur1 = pygame.transform.scale(joueur1,(120,60))
joueur2 = pygame.image.load('files/joueur2.png').convert_alpha(fenetre)
joueur2 = pygame.transform.scale(joueur2,(120,60))

goal1 = pygame.image.load('files/goal1.png').convert_alpha(fenetre)
goal1 = pygame.transform.scale(goal1,(160,220))
goal2 = pygame.image.load('files/goal2.png').convert_alpha(fenetre)
goal2 = pygame.transform.scale(goal2,(160,220))

logo = pygame.image.load('files/logo.png').convert_alpha(fenetre)
logo = pygame.transform.scale(logo,(120,120))

reprendre = pygame.image.load('files/reprendre.png').convert_alpha(fenetre)
reprendre = pygame.transform.scale(reprendre,(400,50))
reprendre2 = pygame.image.load('files/reprendre2.png').convert_alpha(fenetre)
reprendre2 = pygame.transform.scale(reprendre2,(400,50))

recommencer = pygame.image.load('files/Recommencer.png').convert_alpha(fenetre)
recommencer = pygame.transform.scale(recommencer,(400,50))
recommencer2 = pygame.image.load('files/Recommencer2.png').convert_alpha(fenetre)
recommencer2 = pygame.transform.scale(recommencer2,(400,50))

quitter = pygame.image.load('files/Quitter.png').convert_alpha(fenetre)
quitter = pygame.transform.scale(quitter,(400,50))
quitter2 = pygame.image.load('files/Quitter2.png').convert_alpha(fenetre)
quitter2 = pygame.transform.scale(quitter2,(400,50))

son3 = pygame.image.load('files/Son.png').convert_alpha(fenetre)
son3 = pygame.transform.scale(son3,(400,50))
son2 = pygame.image.load('files/Son2.png').convert_alpha(fenetre)
son2 = pygame.transform.scale(son2,(400,50))

message = pygame.image.load('files/message.png').convert_alpha(fenetre)
message = pygame.transform.scale(message,(300,130))

mur = pygame.mixer.Sound("files/mur.wav")
balj = pygame.mixer.Sound("files/joueur.wav")
man = pygame.mixer.Sound("files/goal.wav")
musique = pygame.mixer.music.load("files/musique.wav")
...
while not fini:
    ...
    #---Balle dans le goal 2
       if ballepos[V] >= 440 and ballepos[H] >= fenetre_l - 85:
          if son : 
    ...
    #---Balle dans le Goal 1
       ...
       #test_collision((0, 455, 130, 20))
       #test_collision((1150, 455, 130, 20))
       test_collision((dessusgoal1pos, (dessusgoallargeur, dessusgoalhauteur)))
       test_collision((dessusgoal2pos, (dessusgoallargeur, dessusgoalhauteur)))
    ...
    #--- Dessin sol et goals
       ...
       #goal1_rect = pygame.Rect((0, 455), (130, 20))
       fenetre.blit(goal2 , (fenetre_l-130.0,455))
       #goal2_rect = pygame.Rect((1150, 455), (130, 20))
       pygame.draw.rect(fenetre, noir, (sol_position, (1500, 200)))
       score()
